...
const HEADER_HTML = `
      ...
      <nav class="header-nav">
        ...
        <a href="./enterprise.html" data-i18n="enterprise">Enterprise</a>
...
const FOOTER_HTML = `
      <div class="footer-inner">
        ...
        <nav class="footer-col" aria-label="Solutions" data-i18n-attr="aria-label:product">
          ...
          <a href="./enterprise.html"><span data-i18n="enterprise">Enterprise</span><svg class="footer-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a>
          ...
          <a href="./docs.html"><span data-i18n="docs">Docs</span><svg class="footer-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a>
        </nav>
...
function markCurrent(root: ParentNode): void {
  ...
  for (const a of root.querySelectorAll<HTMLAnchorElement>(CURRENT_SCOPE)) {
    ...
    // A hash link is a place on a page, not a page of its own.
